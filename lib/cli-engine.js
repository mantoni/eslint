...
class CLIEngine {
    ...
    constructor(providedOptions) {
        ...
        if (this.options.cache) {
             ...
             * @type {Object}
             */
            this._lintResultCache = this.createResultCache();
        }
    }
    ...
    createResultCache() {
        ...
        return new LintResultCache(cacheFile, this.config);
    }
     ...
     * @param {Object} resultCache An optional result cache instance to use.
     * @returns {Object} The results for all files that were linted.
     */
    executeOnFiles(patterns, resultCache) {
        const options = this.options,
            lintResultCache = resultCache || this._lintResultCache,
            configHelper = this.config;

        if (!options.cache && !resultCache) {
            const cacheFile = getCacheFile(this.options.cacheLocation || this.options.cacheFile, this.options.cwd);
        ...
        if (lintResultCache) {
            ...
            lintResultCache.reconcile(!!options.cache);
        }
